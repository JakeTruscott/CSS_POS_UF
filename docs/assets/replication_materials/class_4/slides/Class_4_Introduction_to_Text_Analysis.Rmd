...
\begin{itemize}
\item Unstructured or Semi-Structured Data -- i.e., data that do not come in a fixed or rigid (numeric) format. Instead consist of free-form content where structure must be inferred rather than assumed.  \par \vspace{2.5mm}
\item Examples: 
\begin{itemize}
