...
2 chasten       negative 
3 zombie        negative 
4 ebulliently   positive 
5 irreplaceable positive 
6 correct       positive 
\end{verbatim}
\end{frame}
...
\begin{itemize}
\item \textbf{Term Frequency - Inverse Document Frequency} (TF-IDF): Strategy that rescales a DFM by its inverse document frequency, down-weighting terms that appear in many documents. \par \vspace{2.5mm}
