...
\item
  ...
  \item
    ...
    language processes (e.g., supervised and unsupervised learning
    models)
...
\begin{frame}{Materials and Evaluation -- Evaluation (Final Project)}
\phantomsection\label{materials-and-evaluation-evaluation-final-project}
\begin{itemize}
\tightlist
\item
  Topic Selection Due Sunday (2/8)

  \par \vspace{1.5mm}
\item
  Submission needs to emphasize some element(s) of course material
...
\item
  ...
  \par \vspace{2.5mm}
\item
  To download \texttt{Python}, visit:
  \url{https://jaketruscott.github.io/CSS_POS_UF/class_1/downloading_Python.html}
