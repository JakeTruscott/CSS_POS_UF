...
\NormalTok{  Code to Assume Input\_1 and Input\_2 }
  
  \FunctionTok{return}\NormalTok{(Return Output Value or Object)}
...
\NormalTok{   Repeating Code Routine}
  \FunctionTok{return}\NormalTok{(Result Value or Object)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
\end{frame}
...
(ggplot::())}\label{data-visualization-ggplot}
...
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{x =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{10}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{100}\NormalTok{), }\AttributeTok{y =} \DecValTok{2} \SpecialCharTok{*}
\NormalTok{    x }\SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{))}

\FunctionTok{ggplot}\NormalTok{(df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y)) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.6}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Linear Relationship with Noise"}\NormalTok{,}
    \AttributeTok{subtitle =} \StringTok{"Points + fitted line are separate layers"}\NormalTok{,}
...
\begin{center}\includegraphics{Class_2_Intermediate_R_Programming_files/figure-beamer/ggplot_example-1} \end{center}
\end{frame}
